...
export class EmailService {
   ...
   */
  static buildTemplate(templateName: string, variables: Record<string, string>): string {
  ...
  private static getFallbackTemplate(name: string, variables: Record<string, string>): string {
