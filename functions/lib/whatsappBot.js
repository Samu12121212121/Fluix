...
// ═══════════════════════════════════════════════════════════════════════════════
exports.whatsappWebhook = (0, https_1.onRequest)({ region: REGION, maxInstances: 20 }, async (req, res) => {
    ...
    if (req.method === "POST") {
        try {
            ...
            const phoneNumberId = (_c = value.metadata) === null || _c === void 0 ? void 0 : _c.phone_number_id;
            const contactName = (_g = (_f = (_e = (_d = value.contacts) === null || _d === void 0 ? void 0 : _d[0]) === null || _e === void 0 ? void 0 : _e.profile) === null || _f === void 0 ? void 0 : _f.name) !== null && _g !== void 0 ? _g : "Cliente";
            ...
            const textoMensaje = (_h = message.text) === null || _h === void 0 ? void 0 : _h.body;
            if (!textoMensaje) {
            ...
            procesarMensajeBot({
                ...
                instruccionesBot: (_j = config.instrucciones_bot) !== null && _j !== void 0 ? _j : "",
                nombreNegocio: (_k = config.nombre_negocio) !== null && _k !== void 0 ? _k : "Negocio",
                sector: (_l = config.sector) !== null && _l !== void 0 ? _l : "",
...
async function procesarMensajeBot(params) {
    const { empresaId, mensaje, telefonoCliente, nombreCliente, phoneNumberId, accessToken, instruccionesBot, nombreNegocio, sector, derivarSiNoSabe, } = params;
