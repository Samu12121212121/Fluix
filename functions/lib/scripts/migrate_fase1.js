...
async function actualizarConfigVerifactu() {
    ...
    const updates = {};
    if (!data.obligatorio_desde)
        updates.obligatorio_desde = '2026-07-01';
    if (!data.fase_implementacion)
        updates.fase_implementacion = 'preparacion';
    if (!data.notas)
        updates.notas = 'Recordar cambiar usar_pruebas:false antes de 2026-07-01';
    if (Object.keys(updates).length > 0) {
...
//# sourceMappingURL=migrate_fase1.js.map