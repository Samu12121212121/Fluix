...
async function enviarEmailBienvenida(email, nombreEmpresa, tempPassword, planNombre) {
    ...
    try {
        ...
        if (crearCuentaAuto && plan) {
            try {
                ...
                await enviarEmailBienvenida(email, nombreEmpresa !== null && nombreEmpresa !== void 0 ? nombreEmpresa : email, tempPassword, plan.nombre).catch((e) => console.warn("⚠️ Email bienvenida no enviado:", e));
