...
exports.onNuevaSugerencia = (0, firestore_1.onDocumentCreated)({ document: "empresas/{empresaId}/sugerencias/{sugerenciaId}", region: REGION }, async (event) => {
    ...
    if (!sugerencia)
        return;
    const textoCompleto = (_b = sugerencia.texto) !== null && _b !== void 0 ? _b : "";
    ...
    try {
        ...
        nombreEmpresa = ((_c = empSnap.data()) === null || _c === void 0 ? void 0 : _c.nombre) || empresaId;
    }
    catch (_) { /* continuar */ }
    ...
    if (tokensPropietario.length > 0) {
        await enviarPush(tokensPropietario, `💡 Nueva sugerencia de ${nombreEmpresa}`, textoCorto, {
