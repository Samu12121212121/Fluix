...
class AnalyticsWebService {
  ...
  Stream<MetricasTraficoWeb> streamMetricas(String empresaId) {
    ...
    return _db
      ...
      return MetricasTraficoWeb(
        ...
        visitasMovil: metricas.visitasMovil,
        visitasDesktop: metricas.visitasDesktop,
        visitasTablet: metricas.visitasTablet,
        ubicaciones: metricas.ubicaciones,
        referrers: metricas.referrers,
  ...
  Future<MetricasTraficoWeb> obtenerMetricas(String empresaId) async {
    try {
      ...
      final metricas = MetricasTraficoWeb.fromMap(doc.data()!);
      
      // Sobrescribir con visitas reales de hoy
      return MetricasTraficoWeb(
        visitasHoy: visitasHoy, // ✅ VALOR CORRECTO DE HOY
        visitasSemana: metricas.visitasSemana,
        visitasMes: metricas.visitasMes,
